...
const GlowingEffect = memo(({ blur = 0, inactiveZone = 0.7, proximity = 0, spread = 20, variant = "default", glow = false, className, movementDuration = 2, borderWidth = 1, disabled = true, }) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { className: cn("pointer-events-none absolute -inset-px rounded-[inherit] border transition-opacity", glow ? "opacity-100" : "opacity-0", variant === "white" && "border-white", disabled && "hidden") }), _jsx("div", { ref: containerRef, style: {
                    "--blur": `${blur}px`,
                    "--spread": spread,
                    "--start": "0",
                    "--active": "0",
